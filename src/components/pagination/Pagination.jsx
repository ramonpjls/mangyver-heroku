...
export const Pagination = ({
    ...
    return (
        ...
        <span style={{marginTop:3}} >Elementos</span>
            <FormControl  sx={{mx:1}} >
            ...
            <Box sx={{mx:1}}>
                ...
                <IconButton  sx={{ mt:0}}  disabled={loading || skipBase <= 0} onClick={firstPage}
                    aria-label="Anterior" size="small">
                        <FirstPageRoundedIcon fontSize="small" />
                </IconButton>

                <IconButton sx={{mr:1, mt:0}} disabled={loading || skipBase <= 0} onClick={previousPage}
                    aria-label="Anterior" size="small">
                ...
                <IconButton  sx={{ml:1, mt:0}}  disabled={loading || ((skipBase + elementsPerPage >= totalElementsInDB ))} onClick={nextPage}
                    aria-label="Anterior" size="small">
                        <ChevronRightRoundedIcon fontSize="small" />
                </IconButton>
                
                <IconButton sx={{mr:1, mt:0}} disabled={loading || ((skipBase + elementsPerPage >= totalElementsInDB ))} onClick={lastPage}
                    aria-label="Anterior" size="small">
                        <LastPageRoundedIcon fontSize="small" />
                </IconButton>
                <span style={{width: '25%', fontWeight: 'bold'}}>Pagina {currentPage} de {totalPages}</span>
